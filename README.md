...
Modern Neovim configuration with LSP, formatting, linting, and completion support.
...
- **[Jujutsu VCS Integration Guide](./JJ_INTEGRATION.md)** - Complete guide for Git + Jujutsu support
- **[snacks.nvim Integration Guide](./SNACKS_INTEGRATION.md)** - Comprehensive snacks.nvim documentation
...
- [neo-tree-jj.nvim](https://github.com/Cretezy/neo-tree-jj.nvim) - Jujutsu for neo-tree
